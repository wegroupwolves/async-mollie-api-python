...
def test_get_issuers(client, response):
    ...
    response.get(
        ...
        "method_get_ideal_with_includes",
    )
    ...
    assert (
        issuer.image_size1x
        == "https://www.mollie.com/images/checkout/v2/ideal-issuer-icons/ABNANL2A.png"
    )
    assert (
        issuer.image_size2x
        == "https://www.mollie.com/images/checkout/v2/ideal-issuer-icons/ABNANL2A%402x.png"
    )
