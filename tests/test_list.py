...
def test_list_multiple_api_calls(client, response):
    ...
    response.get(
        "https://api.mollie.com/v2/customers?from=cst_8pknKQJzJa&limit=5",
        "customers_list_second",
    )
    response.get(
        "https://api.mollie.com/v2/customers?from=cst_prs8JjDf57&limit=5",
        "customers_list_third",
    )
    response.get(
        "https://api.mollie.com/v2/customers?from=cst_g328m9rhGe&limit=5",
        "customers_list_fourth",
    )
    response.get(
        "https://api.mollie.com/v2/customers?from=cst_prs8JjDf57&limit=5",
        "customers_list_third",
    ...
    response.get(
        "https://api.mollie.com/v2/customers?from=cst_HwBHgJgRAf&limit=5",
        "customers_list_first",
    )
